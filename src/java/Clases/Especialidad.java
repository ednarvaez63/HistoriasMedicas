...
public class Especialidad {
    ...
    public Especialidad(String id) {
        String cadenaSQL="select id, nombreE, decripcion from especialidad where id="+id;
        try {
    ...
    public void guardar(){
        String cadenaSQL="insert into especialidad (nombreE, decripcion) values('"+nombreE+"','"+descripcion+"')";
    ...
    public static ResultSet getLista(String filtro){
        ...
        String cadenaSQL=" select id, nombreE, decripcion from especialidad "+filtro+"  by id";
