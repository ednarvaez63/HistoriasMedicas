...
public class TipoUsuario {
    ...
    public TipoUsuario(String id) {
        String cadenaSQL="select id, nombreTU, decripcion from tipoUsuario where id="+id;
        try {
    ...
    public String getMenu(){
        String menu="<ul>";
        menu+="<a href='principal.jsp?CONTENIDO=configuracion/tipoUsuarios.jsp'><td>  TIPO DE USUARIO   ||</td></a>";
        menu+="<a href='principal.jsp?CONTENIDO=configuracion/Especialidades.jsp'><td>  ESPECIALIDADES   ||</td></a>";
        menu+="<a href='principal.jsp?CONTENIDO=historia/historias.jsp'><td>  HISTORIAS   ||</td></a>";
